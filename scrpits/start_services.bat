...
start "Celery Worker" cmd /k "venv\Scripts\activate.bat && celery -A order_fulfillment worker -l info"
...
start "Celery Beat" cmd /k "venv\Scripts\activate.bat && celery -A order_fulfillment beat -l info"
